...
![ADT new project default settings](/posts/Android/new-project.png)

*（注：本文所述方法是以牺牲新的 API 为代价的。）*

默认生成的 apk 文件大小（903KB）：

![default apk size](/posts/Android/default-size.png)
...
1. 从 HelloWorld 工程设置中移除库依赖
   ...
   ![remove appcompat\_v7](/posts/Android/remove-appcompat.png)
...
![apk size without appcompat\_v7](/posts/Android/size-without-v7.png)
...
![remove private libraries](/posts/Android/private-library.png)

然后 Clean 和 Refresh 工程，再看生成的 HelloWorld.apk 的大小（45KB）：

![size without v4 library](/posts/Android/size-without-v4.png)
